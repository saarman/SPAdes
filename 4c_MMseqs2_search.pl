...
# Step 1: Generate a m8 from easy-search with ref seqs agains representatives for each cluster
...
system($easy-search_cmd) == 0 or die "MMseqs2 easy-search command failed: $?";

print "Running MMseqs2 createdb1_cmd...\n";
system($createdb1_cmd_cmd) == 0 or die "MMseqs2 createdb1_cmd command failed: $?";
